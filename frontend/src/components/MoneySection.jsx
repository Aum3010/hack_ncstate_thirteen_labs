...
export default function MoneySection() {
  ...
  return (
    <div className="money-section-embedded">
      ...
      <section className="dossier-panel money-section">
        ...
        {wallets?.length > 0 ? (
          ...
          <p className="text-muted">No wallet linked. Connect a wallet in the Solana wallet section above.</p>
        )}
      </section>
      <section className="dossier-panel money-section">
        ...
        {!showForm ? (
          ...
          <form onSubmit={handleSubmit} className="money-form">
            <label className="input-label" htmlFor="modal-tx-type">Type</label>
            <select id="modal-tx-type" className="input" value={form.type} onChange={(e) => setForm({ ...form, type: e.target.value })}>
